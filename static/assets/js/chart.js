...
$(document).ready(function() {
  ...
  if (doughnut !== null) {
    var myDoughnutChart = new Chart(doughnut, {
      type: "doughnut",
      data: {
        labels: ["MLP training", "MLP testing", "SVM training", "SVM testnig"],
        datasets: [
          {
            label: ["MLP training", "MLP testing", "SVM training", "SVM testnig"],
            data: [90, 85, 89, 86],
      ...
      options: {
        ...
        tooltips: {
          callbacks: {
            title: function(tooltipItem, data) {
              return "Accuracy : " + data["labels"][tooltipItem[0]["index"]];
            },
            label: function(tooltipItem, data) {
              return data["datasets"][0]["data"][tooltipItem["index"]];
            }
